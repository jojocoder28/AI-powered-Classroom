      ...
      <div className="max-w-md w-full space-y-8 rounded-xl shadow-lg p-8 bg-gray-100 dark:bg-gray-800 neomorphic">
        ...
        <form className="mt-8 space-y-6">
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-gray-800 bg-amber-400 hover:bg-amber-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 neomorphic"
            >
              Sign in
            </button>
          </div>
